...
function preload(){
  ...
  obstacle1 = loadImage("ground2.png");
  obstacle2 =  loadImage("cloud.png");
  obstacle3 =  loadImage("cloud.png");
...
function setup() {
 ...
 police1.addAnimation("running", police )
  ...
  obs1 = createSprite(300,140);
  obs1.addImage(obstacle1);

  obs2 = createSprite(300,140);
  obs1.addImage(obstacle2);

  obs3 = createSprite(300,140);
